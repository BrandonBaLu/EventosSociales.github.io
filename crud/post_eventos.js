function Post_eventos() {
    ...
    request.onload = () => {
        ...
        if (request.status==400 || request.status == 401 || request.status == 403) {
            ...
            */
            ...
            else if (codeapi == 201 && messageapi == "Evento creado" && level == 1){
                Swal.fire({
                    title: json.message,
            ...
            else if (codeapi != 201 && messageapi != "Evento creado" && level == 0){
                Swal.fire({
                    title: json.message,
                    text: "Redireccionando...",
                    type: "error"
    ...
    if (nombre.value == "" || fecha.value == "" || hora.value == "" || lugar.value == "" || descripcion.value == "" || precio.value == "" || ruta == "https://via.placeholder.com/150"){
        Swal.fire({
            title: "Error",
