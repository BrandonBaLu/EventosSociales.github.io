    ...
    request.onload = () => {
        ...
        if (code1 ==201 && message1 == "Usuario creado"){
            Swal.fire({
                ...
                window.location = "/EventosSociales.github.io/templates/login.html";
            });
        }
        ...
        if (code==400 && message == "EMAIL_EXISTS"){
            Swal.fire({
                ...
                window.location = "/EventosSociales.github.io/templates/registro.html";
            });
        }  
    ...
    request.onload = () => {
        ...
        if (code==400 && message == "EMAIL_EXISTS"){
            Swal.fire({
                ...
                window.location = "/EventosSociales.github.io/admin/templates/registro.html";
            });
        }  
        else if(code==400 && message== "INVALID_EMAIL"){                
            Swal.fire({
